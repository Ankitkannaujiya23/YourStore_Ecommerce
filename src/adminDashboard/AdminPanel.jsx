      ...
      <header className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <span className="absolute top-0 right-0 bg-purple-600 text-white text-xs rounded-full px-1">3</span>
      ...
      <div className="grid grid-cols-3 gap-6">
            ...
            <tbody>
              {[
                ...
                <tr key={index} className="border-b">
                  ...
                  <td className="p-2">
                    <span className={`px-2 py-1 rounded-full text-xs bg-${product.status === "Active" ? "green" : "yellow"}-200 text-${product.status === "Active" ? "green" : "yellow"}-800`}>
                      {product.status}
                    </span>
                  </td>
        ...
        <div className="bg-white p-4 rounded-lg shadow-md">
          <div className="flex justify-between items-center mb-4">
            ...
            <button className="bg-purple-600 text-white px-4 py-2 rounded-md">+ Add</button>
          </div>
          <ul>
            {[
