...
const ProductDetailsPage = () => {
  ...
  const gotoBuyNow = () => {
    dispatch(addItemIntoCart({ ...getSelectedData, quantity: 1 }));
    navigate("/cart");
  };
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">
                  {getSelectedData?.stock} reviews
                </p>
              </div>
              <p className="text-gray-700 ">
                {getSelectedData?.rating} out of 5 stars
              </p>
            </div>
