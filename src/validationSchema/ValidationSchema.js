...
export const AddOrUpdateSchema=()=> yup.object({
    productTitle:yup.string().required('*Please enter product name.').min(3),
    productDescription:yup.string().required('*Please enter description.').min(10),
...
export const addressDetailsValidation=yup.object({
    ...
    mobileNo:yup.string().required("Enter your Mobile No").matches(/^[6-9]\d{9}$/, "Enter valid mobile no").min(10).max(10),
